...
class Hospital(models.Model):
    ...
    accepted_insurance = models.CharField(max_length=5000, default="NHIF accredited")
    phone_number = models.CharField(max_length=200,default="no phone number")
    placepageUri = models.CharField(max_length=200,default="no place page uri")
    ...
    ambulance_contacts = models.CharField(max_length=50000, default="no ambulance contact")
    ...
    def get_url(self):
        return reverse('product_detail', kwargs={'pk': self.pk})#'uuid':self.uuid
